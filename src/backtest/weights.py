"""
Weighting module.
Implements basic strategies for converting scores into portfolio weights.
Supports:
...
def equal_weight_long_short(scores: pd.DataFrame, long_pct: float = 0.1, short_pct: float = 0.1) -> pd.DataFrame:
    """
